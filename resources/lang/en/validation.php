...
return [
    ...
    */
    ...
    | Isso facilita a especificação de uma linha de linguagem personalizada
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas de linguagem a seguir são usadas para trocar o espaço reservado
    | de atributo por algo mais amigável ao leitor, como "Endereço de E-mail"
