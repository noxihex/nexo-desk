...
@section('title', 'BTXDesk - Editar Empresa')
...
<div class="card mt-4">
    <div class="card-header d-flex flex-column flex-md-row align-items-md-center">
        ...
        <a href="{{ route('clientes.create', ['empresa_id' => $empresa->id]) }}"
           class="btn btn-success ml-md-auto">
    ...
    <div class="card-body p-0 table-responsive">
        <table class="table table-striped">
            <thead>
                <tr>
                    <th class="d-none d-md-table-cell">ID</th> <!-- Ocultar em telas pequenas -->
                    <th>Nome</th>
                    <th>Email</th>
                    <th>Status</th>
            ...
            <tbody>
                @forelse($clientes as $cliente)
                    <tr>
                        <td class="d-none d-md-table-cell">{{ $cliente->id }}</td> <!-- Ocultar em telas pequenas -->
                        <td>{{ $cliente->name }}</td>
                        <td>{{ $cliente->email }}</td>
                        <td>
