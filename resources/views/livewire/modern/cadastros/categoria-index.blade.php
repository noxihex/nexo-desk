<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <x-modern.button :href="route('categorias.create')" icon="plus">Nova categoria</x-modern.button>
    </div>
                    ...
                    <x-modern.table.row :key="$record->id">
                        ...
                        <x-modern.table.cell>
                            <div class="flex flex-wrap gap-2">
                                <x-modern.button :href="route('categorias.edit', $record)" variant="outline" size="sm" icon="pencil-square" :aria-label="'Editar '.$record->nome">Editar</x-modern.button>
