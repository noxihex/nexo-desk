...
Foram conferidos no navegador os dois relatórios, filtros sincronizados com a URL, temas claro/escuro, gráficos SVG, tabela de dados do gráfico, totais, badges de status/SLA, abertura da impressão e retorno ao sistema. No mobile, a largura do documento permaneceu igual à viewport de 390 px; tabelas extensas rolam dentro do card.
...
Validação automatizada: `ModernReportsTest` com oito testes e 72 asserções, suíte completa com 201 testes e 1577 asserções, além de `npm run build`.
