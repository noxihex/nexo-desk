...
- `npm run dev` builds JavaScript and Sass with source maps; `npm run watch` rebuilds on changes.
- `npm run prod` creates optimized production assets.
